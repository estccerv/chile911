        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Flexible(
                                child: FlutterFlowDropDown<SurveyType>(
                                  controller: _model.typeValueController ??=
                                      FormFieldController<SurveyType>(
                                    _model.typeValue ??= SurveyType.survey,
                                  ),
                                  options:
                                      List<SurveyType>.from(SurveyType.values),
                                  optionLabels: [
                                    FFLocalizations.of(context).getText(
                                      'zedp3f57' /* Encuesta */,
                                    ),
              ...
              FFButtonWidget(
                onPressed: () async {
                  await SurveysRecord.collection
                      .doc()
                      .set(createSurveysRecordData(
                        timestamp: getCurrentTimestamp,
                        type: _model.typeValue,
                        title: _model.titleTextController.text,
                        description: _model.descriptionTextController.text,
                        closingTimestamp: _model.dateModel.datePicked,
                      ));
                  Navigator.pop(context);
                },
                text: FFLocalizations.of(context).getText(
                  '91kq6zvr' /* Crear Anuncio */,
                ),
