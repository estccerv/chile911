...
import 'notifications_content_model.dart';
export 'notifications_content_model.dart';
...
class _NotificationsContentWidgetState
  ...
  late NotificationsContentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotificationsContentModel());
